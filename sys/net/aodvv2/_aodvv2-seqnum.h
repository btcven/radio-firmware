...
#ifndef PRIV_AODVV2_SEQNUM_H
#define PRIV_AODVV2_SEQNUM_H
...
static inline aodvv2_seqnum_t _aodvv2_seqnum_new(void)
{
    aodvv2_seqnum_t tmp = _aodvv2_seqnum_get();
    _aodvv2_seqnum_inc();
    return tmp;
}
 ...
 */
static inline int16_t _aodvv2_seqnum_cmp(aodvv2_seqnum_t existing,
